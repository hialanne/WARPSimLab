...
a = Analysis(
    ...
    datas=[
        ...
        ('src/warpsimlab/exampleFiles/financialDataRetired.json', 'exampleFiles'),
        ('src/warpsimlab/exampleFiles/financialDataRetiredBad.json', 'exampleFiles'),
        ...
        ('src/warpsimlab/exampleFiles/financialDataZero.json', 'exampleFiles'),
        ('LICENSE.txt', '.'),
        ],
    hiddenimports=[],
    hookspath=[],
