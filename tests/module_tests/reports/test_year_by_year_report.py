...
def test_calculate_summary_statistics_uses_totals_maximum_and_last_row():
    ...
    assert stats["Total Retirement Withdrawals"] == pytest.approx(100.0)
    assert stats["Largest Annual Retirement Withdrawal"] == pytest.approx(100.0)
