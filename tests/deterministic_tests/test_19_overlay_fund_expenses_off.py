...
def test_overlay_fund_expenses_off_attaches_series_and_exceeds_baseline(monkeypatch):
    ...
    def fake_simulate_yearly_portfolios(
        ...
        results = {
            ...
            "hsa_equity": zeros.copy(),
            "hsa_bonds": zeros.copy(),
            "hsa_cash": zeros.copy(),
            ...
            "pre_tax_withdrawals": zeros.copy(),
            "roth_withdrawals": zeros.copy(),
            "hsa_withdrawals": zeros.copy(),
            "hsa_qualified_withdrawals": zeros.copy(),
            "hsa_taxable_withdrawals": zeros.copy(),
            "expense_amt": np.array([[25.0, 25.0, 25.0, 25.0]]),
            "ira_401k": zeros.copy(),
            "employee_401k_contributions": zeros.copy(),
            "hsa_employee_contributions": zeros.copy(),
            "hsa_employer_contributions": zeros.copy(),
            "hsa_total_contributions": zeros.copy(),
            ...
            "breakdown_by_class": {
                ...
                "tax_funding_withdrawal": zeros.copy(),
