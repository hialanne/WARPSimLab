...
def test_year_zero_pre_tax_and_post_tax_match_initial_inputs_single_person(make_case):
    ...
    expected_pre_tax = husband_portfolio.equity_pre + husband_portfolio.bond_pre + husband_portfolio.cash_pre
    expected_post_tax = husband_portfolio.equity_post + husband_portfolio.bond_post + husband_portfolio.cash_post
