...
def _render_year_table(report_data):
    ...
    header_labels = {
        ...
        "Emergency Pre-Tax Withdrawal": "Emergency<br>Tax-Deferred<br>Withdrawal",
        ...
        "Pre-Tax Equity": "Tax-Deferred<br>Equity",
        "Pre-Tax Bonds": "Tax-Deferred<br>Bonds",
        "Pre-Tax Cash": "Tax-Deferred<br>Cash",
        "Pre-Tax Assets": "Tax-Deferred<br>Total",

        "Post-Tax Equity": "Taxable<br>Equity",
        "Post-Tax Bonds": "Taxable<br>Bonds",
        "Post-Tax Cash": "Taxable<br>Cash",
        "Post-Tax Assets": "Taxable<br>Total",
...
<section>
    ...
    <p class="section-intro">
        ...
        strategy. Emergency Tax-Deferred Withdrawal shows additional tax-deferred assets used when
