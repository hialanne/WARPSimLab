...
class PortfolioSimulatorGUI_IOMixin:
    ...
    def print_gui_state_table(self):
        ...
        print(f"{'Bond Taxable':35} | {money(self.bond_post_h_var)}")
        print(f"{'Cash Tax-Deferred':35} | {money(self.cash_pre_h_var)}")
        ...
        print(f"{'Bond Taxable':35} | {money(self.bond_post_w_var)}")
        print(f"{'Cash Tax-Deferred':35} | {money(self.cash_pre_w_var)}")
        print(f"{'Cash Taxable':35} | {money(self.cash_post_w_var)}")
